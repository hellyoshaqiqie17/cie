...
const sampleMessagesDataArray: TMessagesData[] = [
  {
    ...
    musicName: "Always - D a n i e l Caesar ",
    messageInParas: [
      "Hey there Yukaa, it's your Graduation! Wishing you the happiest of graduation filled with all the things you love and cherish the most.",
  ...
  },
  {
    ...
    musicName: "intro(end of the world) - Ariana Grande",
    messageInParas: [
      "Happy Graduation!! On this special day, I hope that all of your dreams come true and that you are surrounded by love and happiness. You are a wonderful person who deserves nothing but the best, and I feel honored to be able to celebrate this special milestone with you.",
      "As you reflect on your academic journey and look forward to the next chapter, I hope that you remember all of the amazing things that you have accomplished and the obstacles that you have overcome. Your determination and hard work inspire those around you, and I am grateful to have you in my life.",
      "May this graduation be just the beginning of a happy journey that will lead you to an even more amazing future. Enjoy this moment to the fullest, and know that you are loved and appreciated by so many.",
      "Once again, happy graduation, YUKAA!! Cheers to a future filled with laughter, love, and wonderful new memories.",
      "love u,",
      "HellyosHaqiqie",
    ],
