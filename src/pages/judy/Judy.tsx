...
const Judy = () => {
  return (
    ...
    >
      ...
      >
        <p className=" text-xl">kcian g bs ktemu di sekola lg wek</p>
        <div className="flex flex-col text-left">
          <Link to={"/wishes"} className="hover:underline">
            wishes untuk yuka jlekk
          </Link>
          <h4>PENCET ATAS INII</h4>
        </div>
      </motion.div>
      {/* Mobile */}
      <motion.div
      ...
      >
        <Marquee transition={{ ...transition }} message="Yukaa." small={true} />
      </motion.div>
      ...
      >
        <Link to={"/wishes"}>wishes untuk yukkaa jleKk</Link>
        <h4>PENCET ATASSS ITUU</h4>
      </motion.div>
      {/* Mobile */}
      <motion.div
        initial={{
